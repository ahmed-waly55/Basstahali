...
export const routes: Routes = [
    // Landing Layout
    {
        ...
        children: [
            ...
            {path:"teacher-form", loadComponent:()=> import("./Features/teacher-form/teacher-form.component").then( m =>m.TeacherFormComponent),  title: "بسطهالي | المنهاج الدراسية "},
            { path: 'subjects/:subjectId', loadComponent: () => import('./Features/subjects/subjects.component').then(m => m.SubjectsComponent), title: "بسطهالي | المواد الدراسية" }
        ]
    },
